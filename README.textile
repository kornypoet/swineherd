...
h4. FileSystem
    ...
    * @mkdir_p@
    ...
    The Swineherd::Filesystem module can be used to move files between all abstractions, using schemed filepaths (hdfs://, s3://,file://).

    For example, instead of doing the following:
    <pre><code>hdfs = Swineherd::HdfsFilesystem.new
    ...
    You can do:
    <pre><code>fs = Swineherd::Filesystem
